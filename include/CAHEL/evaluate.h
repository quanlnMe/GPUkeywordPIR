...
inline void mod_switch_to(const CAHELGPUContext &context, const CAHELGPUPlaintext &plain, CAHELGPUPlaintext &destination,
                          size_t chain_index) {
...
inline void mod_switch_to(const CAHELGPUContext &context, const CAHELGPUCiphertext &encrypted, cahel::parms_id_type parms_id,
                          CAHELGPUCiphertext &destination) {
    if (&encrypted == &destination)
        mod_switch_to_inplace(context, destination, parms_id);
    else {
